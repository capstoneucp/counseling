...
<head>
    ...
    <table width="50%" bgcolor="white" border="0" align="center" > 
        ...
        <tr>
            <td>
            <input type="text" name="firstname"  size="25px" required="required" style="height:30px; size:10;"/></td>

            <td>
            <input type="text" name="midname"  size="25px" required="required" style="height:30px; size:10;"/></td>
            
            <td>
            <input type="text" name="lastname" size="25px" required="required" style="height:30px; size:10;"/></td>
            <td>
...
<td>
  ...
  <tr><td><br></td></tr>
    ...
    <tr>
   <td align="center">
    <input type='submit' value='Submit ' name="ssubmit" style="width:30%; height:35px;
