...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <tr>
                      ...
                      <th style="text-align: center;"><im"20px" height="20px">
                        <font color="white" size="4">Appointment Form </font></th>
    ...
    <tr ><br>
      <td><label>Name: <input class="form-control" type="text" name="fullname" placeholder="Full Name" required></label></td>
