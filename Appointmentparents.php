...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <tr>
                      ...
                      <th style="text-align: center;"><im"20px" height="30px">
                        <font color="white" size="4">Appointment Request Form for Parents</font></th>
    ...
    <tr ><br>
      <td><label>Name of Parents:<input class="form-control" type="text" name="fullname" placeholder="Full Name" required></label></td>
      <td><label>Course:</label>
            <select name='course' id='course' class="form-control" 
                style="height:35px; width:170px; align:center;">
    ...
    <tr>
   <td align="center">
    <input type='submit' value='Submit ' name="asubmit" style="width:30%; height:35px;
