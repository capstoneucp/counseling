...
if(isset($_POST['basubmit'])){
  ...
  $counselor = $_POST['counselor'];
    ...
    $receiver = "$email";
    $subject = "The counselor set and appointment for you";
    $body = "Your appointment date is $d at $t and your counselor is $counselor";
...
<body>
    ...
    <tr>
   <td align="center">
    <input type='submit' value='Submit ' name="basubmit" style="width:30%; height:35px;
